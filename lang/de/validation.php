...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        // The rework's own column names ([[08-accounts]]). Legacy's form posted
        // `firstname`/`name`; the schema calls them `first_name`/`last_name`,
        // and these are the fields the registration and checkout forms send.
        'company' => 'Firma',
        'street' => 'Strasse',
        'street_no' => 'Nummer',
        'zip' => 'PLZ',
