 ...
 * red. `leading-[normal]`, as legacy's normalize sets on inputs. `readonly`
 * draws the value without the rule — the course number, which the server
 * assigns.
 */
...
<template>
	<div class="relative mb-16 lg:mb-32">
		...
		<input
			...
			:class="readonly ? 'border-b border-transparent' : error ? 'border-b border-danger' : 'border-b border-black'"
		/>
